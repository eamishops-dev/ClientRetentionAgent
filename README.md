# Агент StomatLine (Cowork + GitHub + Asana) — спрощена модель
...
0. Перевір approval-статус своїх останніх 3 задач-фігур (GID — у `cowork/ASANA_TASKS.md`): Approved → фігура в свій `GOLDEN.md` = закрита територія (впроваджує Амір), не розвивати і не дублювати; Rejected → мітка [відхилено] в `_index.md`, тип не повторюй; Request changes → доопрацюй ту саму фігуру: є коментарі — врахуй; нема — дай альтернативний варіант.
...
- **GOLDEN.md** у папці кожного агента — карта закритих територій: прийняті фігури, які Амір впроваджує сам. Функція голда — антидубль і повнота картини ніші, не вектор розвитку. Кожен пише і читає ТІЛЬКИ свій GOLDEN. Мета — щоденні сильні свіжі різносторонні рішення, не биття в одну точку.
